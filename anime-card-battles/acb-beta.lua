...
local Fluent = function()
	...
	local Themes = {
		...
		TestTheme3 = {
			Name = "TestTheme3",
			Accent = Color3.fromRGB(128, 187, 166), -- Darker Mint
		
			AcrylicMain = Color3.fromRGB(30, 30, 30),
			AcrylicBorder = Color3.fromRGB(92, 151, 144), -- Darkened Aqua for more contrast
			AcrylicGradient = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(128, 187, 166)),
				ColorSequenceKeypoint.new(0.25, Color3.fromRGB(92, 151, 144)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(164, 187, 185)),
				ColorSequenceKeypoint.new(0.75, Color3.fromRGB(92, 151, 144)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(128, 187, 166)),
			},
			AcrylicNoise = 0.92,
		
			TitleBarLine = Color3.fromRGB(92, 151, 144),
			Tab = Color3.fromRGB(92, 151, 144),
		
			Element = Color3.fromRGB(128, 187, 166),
			ElementBorder = Color3.fromRGB(70, 120, 110), -- Darkened for more contrast
			InElementBorder = Color3.fromRGB(184, 207, 205), -- Lightened for contrast
			ElementTransparency = 0.5, -- Further reduced transparency
		
			ToggleSlider = Color3.fromRGB(128, 187, 166),
			ToggleToggled = Color3.fromRGB(92, 151, 144),
			TransparenToggle = 0.6, -- Slightly reduced transparency
		
			SliderRail = Color3.fromRGB(164, 187, 185),
		
			DropdownFrame = Color3.fromRGB(92, 151, 144),
			DropdownHolder = Color3.fromRGB(80, 130, 120),
			DropdownBorder = Color3.fromRGB(60, 100, 90), -- Darkened for more contrast
			DropdownOption = Color3.fromRGB(128, 187, 166),
		
			Keybind = Color3.fromRGB(128, 187, 166),
		
			Input = Color3.fromRGB(92, 151, 144),
			InputFocused = Color3.fromRGB(164, 187, 185),
			InputIndicator = Color3.fromRGB(128, 187, 166),
			InputIndicatorFocus = Color3.fromRGB(92, 151, 144),
		
			Dialog = Color3.fromRGB(128, 187, 166),
			DialogHolder = Color3.fromRGB(92, 151, 144),
			DialogHolderLine = Color3.fromRGB(164, 187, 185),
			DialogButton = Color3.fromRGB(128, 187, 166),
			DialogButtonBorder = Color3.fromRGB(70, 120, 110), -- Darkened for more contrast
			DialogBorder = Color3.fromRGB(60, 100, 90), -- Darkened for more contrast
			DialogInput = Color3.fromRGB(92, 151, 144),
			DialogInputLine = Color3.fromRGB(164, 187, 185),
		
			Text = Color3.fromRGB(240, 240, 240),
			SubText = Color3.fromRGB(200, 200, 200),
			Hover = Color3.fromRGB(92, 151, 144),
			HoverChange = 0.05, -- Slightly increased for more noticeable hover effect
		},
		TestTheme4 = {
			Name = "TestTheme4",
