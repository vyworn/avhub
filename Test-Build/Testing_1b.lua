...
function AvHub:Function()
    ...
    local function checkInventory()
        ...
        local instantRoll = playergui:FindFirstChild("InstantRoll")
        if not instantRoll then
            currentlyChecking = false
            return false
        end
    
        local inventory = instantRoll:FindFirstChild("InstantPullLibrary") and instantRoll.InstantPullLibrary.Inventory
        ...
        if cardChanceText and tonumber(cardChanceText.Text) then
            local cardChance = tonumber(cardChanceText.Text)
                ...
                if cardChance >= cardChanceThreshold and isWebhookToggleActive() then
    ...
    self.handleWebhooks = function()
        ...
        if not instantConnection then
            instantConnection = playergui.InstantRoll.ChildAdded:Connect(checkInventory)
        end
